      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex flex-col items-center">
            <a href="/contact" className="border-2 border-red-500 bg-white text-gray-900 px-6 py-2 rounded-full font-semibold hover:bg-gray-100 transition-colors inline-block text-center">
              CONTACT US
            </a>
          </div>
